...
const AccountingFinancial = () => {
  ...
  const modules = [
    {
      id: 'module-a',
      title: 'Module A',
      name: 'Accounting Principles and Processes',
      chapters: [
    ...
    },
    {
      id: 'module-b',
      title: 'Module B',
      name: 'Financial Statements and Core Banking System',
      chapters: [
        'Final Accounts of Banking Companies',
        'Balance Sheet and Profit & Loss Account',
        'Accounting in Core Banking Solutions (CBS)',
        'Accounting Standards and IFRS',
        'Non-Performing Assets – Classification and Provisioning'
      ]
    },
    {
      id: 'module-c',
      ...
      chapters: [
        ...
        'Capital Budgeting and Financial Ratios',
    ...
    },
    {
      id: 'module-d',
      title: 'Module D',
      name: 'Taxation and Fundamentals of Costing',
      chapters: [
        'Taxation Basics – Direct and Indirect Taxes',
        'GST in Banking Sector',
        'Costing Concepts and Break-even Analysis',
  ...
  const handleStartQuiz = (moduleId: string, chapterIndex: number) => {
    ...
    // navigate(`/jaiib/accounting-financial/${moduleId}/quiz/${chapterIndex}`);
  };
    ...
    <div className="min-h-screen w-full bg-auth-gradient p-4 animate-fade-in">
      <div className="max-w-7xl mx-auto">
        <div className="mb-8 flex items-center">
          ...
          <div>
            <h1 className="text-3xl font-bold text-white">Accounting & Financial Management for Bankers</h1>
